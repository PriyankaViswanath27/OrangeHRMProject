...
public class ActionDriver {
	...
	// To use logger instance in this class, we just need to add below statement
	...
	// Method to enter text into an input field -- Avoid code duplication - fix
	...
	public void enterText(By by, String value) {
		try {
			...
			logger.error("Unable to enter the value in input textbox:" + e.getMessage());
		}
	}

	// Method to get a text from input field
	...
	// Method to compare Two text -- changed return type to boolean 
	 ...
	 * { try { waitForElementToBeVisible(by); boolean
	...
	// By --- This is a dynamic wait based on condition is met
	...
	//Utiltiy method to truncate long string
